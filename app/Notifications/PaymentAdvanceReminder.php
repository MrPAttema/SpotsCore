...
class PaymentAdvanceReminder extends Notification
{
    ...
    {   
        ...
        ->line('Over 6 weken staat uw verblijf ingepland in de '.$location->location_name.' te '.$location->location_location.'.')
        ->line('Wij willen u er aan herinneren dat wij uw huurbetaling nog niet hebben ontvangen, deze dient conform onze voorwaarden maximaal 31 dagen voor vertrek bij ons binnen te zijn.')
